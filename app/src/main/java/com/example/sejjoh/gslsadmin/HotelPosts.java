...
public class HotelPosts extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hotel_posts);
    ...
    private void startPosting() {
        mProgresss.setMessage("uploading to hotels...");
        mProgresss.show();
        ...
        {
            final StorageReference filepath=mStorage.child("Hotel_Images").child(mImageUri.getLastPathSegment());
            ...
            Task<Uri> urlTask= uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    if (task.isSuccessful()){
                        ...
                        newPost.child("hotelName").setValue(title_val);
                        newPost.child("description").setValue(Desc_val);
                        newPost.child("image").setValue(downloadUri.toString());
                        mProgresss.dismiss();
                        startActivity(new Intent(HotelPosts.this,Hotel.class));
