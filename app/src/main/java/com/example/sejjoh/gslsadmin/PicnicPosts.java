...
public class PicnicPosts extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_picnic_posts);
        mStorage= FirebaseStorage.getInstance().getReference();
        mDatabase= FirebaseDatabase.getInstance().getReference().child("Picnic_sites");
    ...
    private void startPosting() {
        mProgresss.setMessage("uploading to picnics...");
        mProgresss.show();
        ...
        {
            final StorageReference filepath = mStorage.child("Picnic_Images").child(mImageUri.getLastPathSegment());
            ...
            Task<Uri> urlTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    if (task.isSuccessful()) {
                        ...
                        newPost.child("picnicName").setValue(title_val);
                        newPost.child("description").setValue(Desc_val);
                        newPost.child("image").setValue(downloadUri.toString());
                        mProgresss.dismiss();
                        startActivity(new Intent(PicnicPosts.this, Picnic.class));
