...
public class BankingPosts extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_banking_posts);
        mAuth=FirebaseAuth.getInstance();
        mCurrentUser= mAuth.getCurrentUser();
        mStorage= FirebaseStorage.getInstance().getReference();
        mDatabase= FirebaseDatabase.getInstance().getReference().child("Banking");
    ...
    private void startPosting() {
        mProgresss.setMessage("uploading...");
        mProgresss.show();
        ...
        {
            final StorageReference filepath=mStorage.child("Banking_Images").child(mImageUri.getLastPathSegment());
            ...
            Task<Uri> urlTask= uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    if (task.isSuccessful()){
                        ...
                        newPost.child("bankName").setValue(title_val);
                        newPost.child("description").setValue(Desc_val);
                        newPost.child("image").setValue(downloadUri.toString());
                        mProgresss.dismiss();
                        startActivity(new Intent(BankingPosts.this,Banking.class));
