...
public class AirportPosts extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_airport_posts);
        mStorage= FirebaseStorage.getInstance().getReference();
        mDatabase= FirebaseDatabase.getInstance().getReference().child("Aiport");
    ...
    private void startPosting() {
        mProgresss.setMessage("Posting to airport...");
        mProgresss.show();
        ...
        {
            final StorageReference filepath=mStorage.child("Airport_Images").child(mImageUri.getLastPathSegment());
            ...
            Task<Uri> urlTask= uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    if (task.isSuccessful()){
                        ...
                        mProgresss.dismiss();
                        startActivity(new Intent(AirportPosts.this,Airport.class));
