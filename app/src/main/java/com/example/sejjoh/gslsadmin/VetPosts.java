...
public class VetPosts extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vet_posts);

            mStorage= FirebaseStorage.getInstance().getReference();
            mDatabase= FirebaseDatabase.getInstance().getReference().child("Veterinary");
        ...
        private void startPosting() {
            mProgresss.setMessage("please wait Posting to veterinary...");
            mProgresss.show();
            ...
            {
                final StorageReference filepath=mStorage.child("Veterinary_Images").child(mImageUri.getLastPathSegment());
                ...
                Task<Uri> urlTask= uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                    ...
                    public void onComplete(@NonNull Task<Uri> task) {
                        if (task.isSuccessful()){
                            ...
                            newPost.child("vetName").setValue(title_val);
                            newPost.child("vetDesc").setValue(Desc_val);
                            newPost.child("vetImage").setValue(downloadUri.toString());
                            mProgresss.dismiss();
                            startActivity(new Intent(VetPosts.this,Veterinary.class));
