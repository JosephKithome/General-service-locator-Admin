...
public class LaundryPosts extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_laundry_posts);

            mStorage= FirebaseStorage.getInstance().getReference();
            mDatabase= FirebaseDatabase.getInstance().getReference().child("Laundry");
        ...
        private void startPosting() {
            mProgresss.setMessage("please wait Posting to Laundry...");
            mProgresss.show();
            ...
            {
                final StorageReference filepath=mStorage.child("Laundry_Images").child(mImageUri.getLastPathSegment());
                ...
                Task<Uri> urlTask= uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                    ...
                    public void onComplete(@NonNull Task<Uri> task) {
                        if (task.isSuccessful()){
                            ...
                            newPost.child("loundryName").setValue(title_val);
                            newPost.child("loudrydesc").setValue(Desc_val);
                            newPost.child("loudryImage").setValue(downloadUri.toString());
                            mProgresss.dismiss();
                            startActivity(new Intent(LaundryPosts.this,Laundry.class));
